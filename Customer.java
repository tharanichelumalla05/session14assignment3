...
//println is used to print text and gives output
	...
	System.out.println("Less balance : waiting for deposit...");  //system is used to return code
    //out is a static member
//println is used to print text and gives output
	...
	this.amount-=amount;  
	System.out.println("withdraw completed");  //system is used to return code
    //out is a static member
//println is used to print text and gives output
	}  
	  
	synchronized void deposit(int amount){   //here it locks the deposit method and 
	System.out.println("going to deposit...!"); //system is used to return code
    //out is a static member
//println is used to print text and gives output 
	this.amount+=amount;   
